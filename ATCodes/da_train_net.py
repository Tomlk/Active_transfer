...
def parse_args():
  ...
  """
    ...
    parser.add_argument(
        "--gpu_id", dest="gpu_id", help="gpu_id", default=0, type=float
    )
...
if __name__ == "__main__":
    ...
    elif args.dataset == "cityscapesfoggy":
        print("loading our dataset...........")
        args.s_imdb_name = "cityscapes_trainval"
        args.t_imdb_name = "cityscapesfoggy_trainval"
        args.s_imdbtest_name = "cityscapes_test"
        args.t_imdbtest_name = "cityscapesfoggy_test"
        args.set_cfgs = [
            "ANCHOR_SCALES",
            "[8,16,32]",
            "ANCHOR_RATIOS",
    ...
    iters_per_epoch = max(s_train_size,t_train_size)
    if args.ef:
