...
from datasets.cityscapesfoggy import cityscapesfoggy
...
for year in ["2007", "2012"]:
    for split in ["train","trainval","test"]:
        name = "cityscapesfoggy_{}".format(split)
        __sets[name] = lambda split=split, year=year: cityscapesfoggy(split, year)
