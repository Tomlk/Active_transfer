...
start_epoch = 6
max_epochs = 12
output_dir = "./data/experiments/SW_Faster_ICR_CCR/cityscapesfoggy/result"
dataset = "cityscapesfoggy"

for i in range(start_epoch, max_epochs + 1):
    model_dir = "./data/experiments/SW_Faster_ICR_CCR/cityscapesfoggy/model/cityscapesfoggy_{}.pth".format(
        i
    )
